...
st.markdown("""
<style>
@import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Share+Tech+Mono&family=Space+Grotesk:wght@400;500;600;700&display=swap');
...
body, p, div, span, label { font-family: 'Inter', sans-serif; color: #94b8e0; }

div[data-testid="stSidebar"] {
    background: #040a14;
    border-right: 1px solid #0d3060;
}
div[data-testid="stSidebar"] * { color: #94b8e0; }
...
.header-title span {
    color: #4d9fff;
    text-shadow: 0 0 20px rgba(77,159,255,0.6);
}
.header-sub {
...
.metric-card {
    background: linear-gradient(145deg, #060e20, #0a1830);
...
.metric-card::after {
    ...
    position: absolute;
    inset: 0;
    background: radial-gradient(circle at 50% 0%, rgba(77,159,255,0.04) 0%, transparent 70%);
    pointer-events: none;
}
.metric-card:hover {
    border-color: #1a5dbb;
    box-shadow: 0 0 20px rgba(77,159,255,0.1), inset 0 0 20px rgba(77,159,255,0.03);
...
.badge-sector { background: rgba(77,159,255,0.08); color: #4d9fff; border: 1px solid rgba(77,159,255,0.2); }
.badge-startup { background: rgba(61,214,140,0.08); color: #3dd68c; border: 1px solid rgba(61,214,140,0.2); }
.badge-emp { background: rgba(167,139,250,0.08); color: #a78bfa; border: 1px solid rgba(167,139,250,0.2); }

div.stButton > button {
    background: linear-gradient(145deg, #060e20, #091525) !important;
    border: 1px solid #0d2a50 !important;
...
div.stButton > button:hover {
    border-color: #1a5dbb !important;
    background: linear-gradient(145deg, #0a1830, #0d2040) !important;
    box-shadow: 0 0 16px rgba(77,159,255,0.08) !important;
    transform: translateY(-1px) !important;
    color: #c8deff !important;
}
div.stButton > button[kind="primary"] {
    background: linear-gradient(135deg, #0d3a8a, #1a5dbb) !important;
    border: 1px solid #2a7adf !important;
    color: #e0eeff !important;
    font-weight: 600 !important;
    box-shadow: 0 0 20px rgba(77,159,255,0.15) !important;
}
div.stButton > button[kind="primary"]:hover {
    background: linear-gradient(135deg, #1a5dbb, #2a7adf) !important;
    box-shadow: 0 0 30px rgba(77,159,255,0.25) !important;
}
...
div[data-testid="stTextArea"] textarea:focus {
    border-color: #1a5dbb !important;
    box-shadow: 0 0 10px rgba(77,159,255,0.1) !important;
}

div[data-testid="stTabs"] { border-bottom: 1px solid #0d2a50; }
div[data-testid="stTabs"] button {
    font-family: 'Share Tech Mono', monospace !important;
    font-size: 0.72rem !important;
    color: #1e4a80 !important;
...
hr { border-color: #0d2a50 !important; }
.stCaption, .stCaption * { color: #1e4a80 !important; font-size: 0.78rem !important; }
p { color: #6a90b8; }
h1,h2,h3,h4 { color: #c8deff !important; font-family: 'Space Grotesk', sans-serif !important; }
...
.detail-title { font-size: 1.3rem; font-weight: 700; color: #e0eeff; margin-bottom: 6px; font-family: 'Space Grotesk', sans-serif; }
.detail-desc { color: #4a7090; line-height: 1.8; margin: 12px 0; }
.detail-key { font-family: 'Share Tech Mono', monospace; font-size: 0.65rem; color: #1e4a80; text-transform: uppercase; letter-spacing: 0.12em; }
.detail-val { font-size: 0.9rem; color: #94b8e0; font-weight: 500; margin-top: 3px; }
</style>
...
# ── Header ─────────────────────────────────────────────────────────
st.markdown('<div class="header-title">🇸🇦 Saudi <span>Companies</span> Directory</div>', unsafe_allow_html=True)
st.markdown('<div class="header-sub">// MARKET INTELLIGENCE PLATFORM — 397 ENTITIES — LIVE FILTERS ACTIVE</div>', unsafe_allow_html=True)
